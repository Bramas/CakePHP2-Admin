...
/**
*   Used to know wheter tinyMce is used or not
*/

	private $_useTinyMce = false;
/**
 ...
 */
	...
	protected function _isAnAdminPanel(){
		return !empty($this->request->params['named']['admin_panel']);
	}
 ...
 */
	...
	private function tinyMceScript()
	{
		$script = '';
		return $script;
	}
	private function useTinyMce()
	{
		$this->_useTinyMce = true;
	}


	public function editor($caption = null, $options = array())
	{
		$this->useTinyMce();
		...
		$options['class'] .= ' tinymce-editor';

		return $this->input($caption, $options);
	}
}
